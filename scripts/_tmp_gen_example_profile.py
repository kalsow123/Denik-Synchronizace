"""Temporary: generate EXAMPLE profile grid entries from grid_report.xlsx."""
import re
...
CONFIG_KEYS = [
    ...
    "prop_firms_enabled", "prop_firms_presets", "prop_firms_account_size_usd", "prop_firms_generate_html",
]
...
p = Path(
    r"c:\Users\a2010\Desktop\TRADING\Trading bot\BOT_EDIT\Pokus 2\Denik\results"
    r"\EURUSD\grid_testing_M30_2025-05-10_2025-10-10_011 - 1000 VARIAC9\grid_report.xlsx"
)
df = pd.read_excel(p, sheet_name="vysledky")
targets = [473, 266, 300, 810, 257]

for cn in targets:
    r = df[df["combo_no"] == cn].iloc[0]
