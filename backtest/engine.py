...
class BacktestEngine:
    ...
    def __init__(
        ...
        *,
        ...
        # 2A: rozhodovaci jadro baru (core/bar_processor.py). Drzi referenci na
        # tento engine; process_bar() na nej deleguje (stav zustava na enginu).
        self._bar_processor = BarProcessor(self)
    ...
    def process_bar(self, i: int, ctx: "BarContext", executor: "Executor") -> None:
        ...
        2A: telo bylo presunuto do `core/bar_processor.BarProcessor.process_bar`.
        Tato metoda zustava jako tenky delegat (verejne API pro testy); stav
        zustava na enginu a BarProcessor k nemu pristupuje pres sdilenou referenci.
        """
        self._bar_processor.process_bar(i, ctx, executor)
